...
**Draft Day** is a When2Meet-style page: the commissioner opens a poll with candidate dates and an hour range in his time zone, each manager paints the hours they're free (click-drag, or tap on a phone; it saves as you go), everyone's marks stack into a heat grid shown in each viewer's own time zone, and the best slots list who's still missing. "Set the draft" on a slot closes the poll and updates the home page countdowns (keepers due a week before).
